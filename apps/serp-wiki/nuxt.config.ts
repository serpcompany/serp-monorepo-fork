export default defineNuxtConfig({
  ...
  auth: {
    baseURL: 'http://localhost:3000/api/auth', // "https://staging.serp-wiki.pages.dev/api/auth",  // process.env.AUTH_ORIGIN,
    provider: {
      type: 'authjs',
      trustHost: false,
  ...
  runtimeConfig: {
    authOrigin: 'http://localhost:3000/api/auth', // "https://staging.serp-wiki.pages.dev/api/auth", //process.env.AUTH_ORIGIN,
