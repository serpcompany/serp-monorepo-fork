export default {
  slots: {
    ...
    base: [
      'inline-flex items-center shrink-0 rounded-full border-2 border-transparent focus-visible:outline-2 focus-visible:outline-offset-2 data-[state=unchecked]:bg-[var(--ui-bg-accented)]',
      'transition-colors duration-200'
    ],
    container: 'flex items-center',
    thumb:
      'group pointer-events-none rounded-full bg-[var(--ui-bg)] shadow-lg ring-0 transition-transform duration-200 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:rtl:-translate-x-0 flex items-center justify-center',
    icon: [
  ...
  variants: {
    color: {
      primary: {
        base: 'data-[state=checked]:bg-[var(--ui-primary)] focus-visible:outline-[var(--ui-primary)]',
        icon: 'group-data-[state=checked]:text-[var(--ui-primary)]'
      },
      secondary: {
        base: 'data-[state=checked]:bg-[var(--ui-secondary)] focus-visible:outline-[var(--ui-secondary)]',
        icon: 'group-data-[state=checked]:text-[var(--ui-secondary)]'
      },
      success: {
        base: 'data-[state=checked]:bg-[var(--ui-success)] focus-visible:outline-[var(--ui-success)]',
        icon: 'group-data-[state=checked]:text-[var(--ui-success)]'
      },
      info: {
        base: 'data-[state=checked]:bg-[var(--ui-info)] focus-visible:outline-[var(--ui-info)]',
        icon: 'group-data-[state=checked]:text-[var(--ui-info)]'
      },
      warning: {
        base: 'data-[state=checked]:bg-[var(--ui-warning)] focus-visible:outline-[var(--ui-warning)]',
        icon: 'group-data-[state=checked]:text-[var(--ui-warning)]'
      },
      error: {
        base: 'data-[state=checked]:bg-[var(--ui-error)] focus-visible:outline-[var(--ui-error)]',
