export default {
  "slots": {
    ...
    "leadingAvatarSize": "",
    "trailing": "group absolute inset-y-0 end-0 flex items-center disabled:cursor-not-allowed disabled:opacity-75" as const,
  ...
  "compoundVariants": [
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-[var(--ui-primary)]"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-[var(--ui-secondary)]"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-[var(--ui-success)]"
    },
    {
      "color": "info" as const,
      "multiple": true,
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-[var(--ui-warning)]"
    },
    {
