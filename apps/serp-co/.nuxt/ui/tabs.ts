  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": {
        ...
        "trigger": "data-[state=active]:text-[var(--ui-bg)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ui-secondary)]"
      }
    },
    {
      ...
      "class": {
        ...
        "trigger": "data-[state=active]:text-[var(--ui-bg)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ui-success)]"
      }
    },
    {
      "color": "info" as const,
      ...
      "class": {
        ...
        "trigger": "data-[state=active]:text-[var(--ui-bg)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ui-info)]"
      }
    },
    {
      ...
      "class": {
        ...
        "trigger": "data-[state=active]:text-[var(--ui-bg)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ui-warning)]"
      }
    },
    {
      ...
      "class": {
        ...
        "trigger": "data-[state=active]:text-[var(--ui-bg)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ui-error)]"
      }
    },
    {
    ...
    },
    {
      ...
      "class": {
        "indicator": "bg-[var(--ui-secondary)]",
        "trigger": "data-[state=active]:text-[var(--ui-secondary)] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ui-secondary)]"
      }
    },
    {
      "color": "success" as const,
      ...
      "class": {
        "indicator": "bg-[var(--ui-success)]",
        "trigger": "data-[state=active]:text-[var(--ui-success)] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ui-success)]"
      }
    },
    {
      "color": "info" as const,
      ...
      "class": {
        "indicator": "bg-[var(--ui-info)]",
        "trigger": "data-[state=active]:text-[var(--ui-info)] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ui-info)]"
      }
    },
    {
      "color": "warning" as const,
      ...
      "class": {
        "indicator": "bg-[var(--ui-warning)]",
        "trigger": "data-[state=active]:text-[var(--ui-warning)] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ui-warning)]"
      }
    },
    {
      "color": "error" as const,
      ...
      "class": {
        "indicator": "bg-[var(--ui-error)]",
        "trigger": "data-[state=active]:text-[var(--ui-error)] focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--ui-error)]"
      }
    },
    {
      "color": "neutral" as const,
