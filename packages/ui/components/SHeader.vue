  ...
  <header>
      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="flex items-center">
          ...
          <div class="ml-6 hidden lg:flex">
            <UNavigationMenu aria-label="Main navigation" orientation="horizontal" highlight :items="headerNavItems"
              :ui="{
    ...
    <div v-if="mobileMenuOpen" class="lg:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3">
        <UNavigationMenu orientation="vertical" highlight :items="headerNavItems" class="w-full" :ui="{
          content: 'absolute top-0',
          childList: 'grid grid-cols-1',
          viewportWrapper:
            'absolute top-full translate-x-[var(--radix-navigation-menu-viewport-position-x)]',
        ...
        <div class="mt-4 border-t border-gray-200 pt-4" v-if="useAuth">
          <profile-dropdown />
        </div>
      </div>
    </div>
