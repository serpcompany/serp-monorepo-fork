...
describe('MultipageHeader Snapshot', () => {
  ...
  it.each([
    ...
    ['with oneLiner and image', { props: { ...baseProps, oneLiner: 'One liner test', image: 'https://example.com/logo.png' } }],
    ...
    const html = await ComponentRender(`MultipageHeader ${desc}`, options, MultipageHeader)
