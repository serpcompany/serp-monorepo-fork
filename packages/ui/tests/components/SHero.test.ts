...
describe('SHero Snapshot Tests', () => {
  it.each([
    ...
    ['with headline and subheadline', { props: { headline: 'Hello World', subheadline: 'This is a subheadline.' } }],
    // Without search bar
    ['without search bar', { props: { headline: 'No Search', showSearchBar: false } }],
    // Without buttons
    ['without buttons', { props: { headline: 'No Buttons', showButtons: false } }],
    // All props customized
    ['with custom all props', { props: { headline: 'Custom Hero', subheadline: 'Amazing subheadline', showSearchBar: false, showButtons: false } }]
