...
export const options = resolveOptions({
  ...
  dirs: {
    ...
    composables: ["composables", "utils", "../composables", "../utils", "../../types/composables", "../../types/utils"],
