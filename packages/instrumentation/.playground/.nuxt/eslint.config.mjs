...
import {
  ...
  defineFlatConfigs,
  resolveOptions
} from '../../../../node_modules/.pnpm/@nuxt+eslint-config@0.6.2_eslint@9.21.0_typescript@5.8.2/node_modules/@nuxt/eslint-config/dist/flat.mjs';
...
export const options = resolveOptions({
  features: {
    standalone: true,
    rootDir: '/app/packages/instrumentation/'
  },
  dirs: {
    pages: ['pages', '../pages'],
