...
export const options = resolveOptions({
  features: {
  "standalone": true,
  "rootDir": "/Users/devin/repos/projects/serp-monorepo/packages/tools/"
},
  dirs: {
    pages: ["pages", "../pages"],
    composables: ["composables", "utils", "../composables", "../utils"],
